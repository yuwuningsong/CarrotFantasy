...
public class UIManager : MonoBehaviour
{
    ...
    public float BuildingHealth{ get; set; }        // 房屋摧毁度
    ...
    void SyncData()
    {
        ...
        BuildingHealth = ((float)GameManager.gameManager.healthTotal - GameManager.gameManager.buildingHealth) / GameManager.gameManager.healthTotal * 100;
